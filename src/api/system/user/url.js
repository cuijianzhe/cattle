const url = {
    loginUserUrl: '/api/v1/account/user/login/',
    currentUserUrl: '/api/v1/account/user/current/',
    logoutUserUrl: '/api/v1/account/user/logout/',
    createUserUrl: '/api/v1/account/user/create/',
